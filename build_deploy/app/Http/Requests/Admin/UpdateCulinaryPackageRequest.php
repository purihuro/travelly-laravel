...
class UpdateCulinaryPackageRequest extends FormRequest
{
    ...
    {
        $culinaryPackage = $this->route('culinary_package');
        ...
        return [
            ...
            'slug' => ['required', 'string', 'max:150', Rule::unique('culinary_packages', 'slug')->ignore($culinaryPackage?->id)],
            ...
            'remove_gallery_image_ids.*' => ['integer', 'exists:culinary_package_galleries,id'],
        ];
    }
}
